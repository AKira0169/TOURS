...
exports.signup = exports.logout = exports.login = exports.disableAconts = exports.deletee = exports.checkOtppp = void 0;
...
var disableAconts = exports.disableAconts = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.status == '204') {
            (0, _alert.showAlert)('success', 'deleted account successfully');
  ...
  return function disableAconts(_x) {
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'Pedding') {
            (0, _alert.showAlert)('success', 'loggend in successfully');
...
var checkOtppp = exports.checkOtppp = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(otp) {
    var res;
  ...
  return function checkOtppp(_x4) {
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(name, email, password, passwordConfirm) {
    var res;
...
var deletee = exports.deletee = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(password) {
    var res;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51O1tEtHsLYMlu4aLdrH0MjRtthabCndbdJSuo3WQBO2oNKKY49zB33D5Zl9hBvPRHmiQ8qxBsiGGPMEPdSX3E8GW00R2C4sKhi');
...
var signupFrom = document.querySelector('.form__signupp');
var logOutBtn = document.querySelector('.nav__el--logout');
var formUserData = document.querySelector('.form-user-data');
var formUserPass = document.querySelector('.form-user-settings');
var delet = document.querySelector('.tezk');
var restsra = document.querySelector('.restsra');
var bookBtn = document.getElementById('book-tour');
var sb = document.getElementById('select');
var btnnn = document.querySelector('.btn--delete-accountt');
var checkotp = document.querySelector('.form--checkOtp');
if (checkotp) {
  checkotp.addEventListener('submit', function (e) {
    e.preventDefault();
    var otp = document.getElementById('password123').value;
    (0, _login.checkOtppp)(otp);
  });
}
if (btnnn) {
  btnnn.onclick = function (e) {
    e.preventDefault();
    var selectedValues = [].filter.call(sb.options, function (option) {
      return option.selected;
    }).map(function (option) {
      return option.text;
    });
    (0, _login.disableAconts)(selectedValues[0]);
  };
}
if (restsra) {
  restsra.addEventListener('submit', function (e) {
    e.preventDefault();
  });
}
if (delet) {
  delet.addEventListener('submit', function (e) {
    e.preventDefault();
    var password = document.getElementById('password1').value;
    (0, _login.deletee)(password);
  });
}
if (loginFrom) {
...
if (signupFrom) {
  signupFrom.addEventListener('submit', function (e) {
    ...
    (0, _login.signup)(username, email, password, confirm_password);
  });
}
if (formUserData) {
...
if (formUserPass) {
  formUserPass.addEventListener('submit', /*#__PURE__*/function () {
